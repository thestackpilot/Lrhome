...
<div class="container-fluid">
    <div class="brand-section">
        <div class="row">
            <div class="width-50">
                <img class="bi bi-x-circle-fill email-logo"
                     src="https://www.lrhome.us/LR/images/LRHome-logo-wide-v7-inverted-color-1.png"
                     onerror="this.onerror=null; this.src=''" height="50" width="100">
    ...
    <div class="body-section border-bottom-0">
        ...
        <div class="width-100 d-flex">
            @if(isset($data['shipping']['BillingFirstName']))
                <div class="width-50">
                    ...
                    <p class="sub-heading">{!! $data['shipping']['BillingCity'] !!}
                        , {!! $data['shipping']['BillingState'] !!}, {!! $data['shipping']['BillingZip'] !!} </p>
            ...
            <div class="width-50">
                ...
                <p class="sub-heading">{!!$data['shipping']['Address1'] == '' ? 'N/A' : $data['shipping']['Address1'] !!} </p>
                <p class="sub-heading">{!! $data['shipping']['City'] !!}, {!! $data['shipping']['State'] !!}
                    , {!! $data['shipping']['Zip'] !!} </p>
                {{-- <p class="sub-heading">Address 2: {!! $data['shipping']['Address2'] == '' ? 'N/A' : $data['shipping']['Address2'] !!} </p> --}}
                {{-- <p class="sub-heading">City: {!! $data['shipping']['City'] !!} </p>
                <p class="sub-heading">State: {!! $data['shipping']['State'] !!}</p>
    ...
    <div class="body-section border-top-0">
        ...
        <div class="margin-bottom-15">
            ...
            <p class="sub-heading">
                SO#: {!! $data['shipping']['SO_Number'] == '' ? 'N/A' : $data['shipping']['SO_Number'] !!} </p>
            <p class="sub-heading">
                PO#: {!! $data['shipping']['CustomerPO'] == '' ? 'N/A' : $data['shipping']['CustomerPO'] !!} </p>
            <p class="sub-heading">Shipping Date: {!! $data['shipping']['ShipDate'] !!} </p>
            <p class="sub-heading">
                Email: {!! $data['shipping']['Email'] == '' ? 'N/A' : $data['shipping']['Email'] !!}</p>
        ...
        <div class="scroll-the-table font-size-14">
            ...
            @foreach($data['items'] as $item)
                <div class="d-flex" style="align-items: center;">
                    <div class="width-50 d-flex" style="align-items: center;">
                        <img class="bi bi-x-circle-fill width-15 width-25" src="{!! $item['Image'] !!}"
            ...
            <div class="text-right">
                ...
                <h3 class="heading"><strong class="padding-right-5">Grand
                        Total:</strong><span>${!! $data['total'] !!}</span></h3>
            </div>

        </div>
        <br>
        <!-- <h3 class="heading">Delivery Method: <span class="sub-heading">{!! $data['shipping']['ShipViaCode'] !!}</span></h3> -->
        <h3 class="heading">Additional Info: <span
                class="sub-heading">{!! array_key_exists('Instructions',$data['shipping']) && $data['shipping']['Instructions'] != '' ? $data['shipping']['Instructions'] : 'N/A' !!}</span>
        </h3>
