...
class AccountController extends DashboardController
{
    ...
    public function change_password(Request $request)
    {
        ...
        if (!Hash::check($validated_data['existing-password'], Auth::user()->password)) {
        ...
        //             //     dd([$validated_data, Auth::user(),['customer_id' => Auth::user()->customer_id, 'password' => $validated_data['existing-password']]]);
        //             //     return redirect()->back()->withInput()->with('message', ['type' => 'danger', 'referer' => 'changepass', 'body' => 'Wrong details for existing password.']);
        //             // } else {
        //             //     dd([$validated_data, 2,Auth::attempt(['email' => Auth::user()->email, 'password' => $validated_data['existing-password']])]);
        //             // }
        //         }
        //     } else {
